...
public class Tester {
    ...
    public static void testIterator(KDTree tree, ArrayList<Datum> points){
        ...
        while (it.hasNext()) {
            ...
            //System.out.println(iterval+" - "+raw_points_setw[ct]);
            if(raw_points_set[ct] != iterval)
                ordering_flag=false;
                //System.out.println("point got " + iterval + " expected val is " + raw_points_set[ct]);
            ct++;
        }
            ...
            case 1: // Test for 1D points
                ...
                switch(op) {
                    ...
                    case RANDOM:
                        ...
                        //int[] highs = {10};
                        System.out.println("***********");
                       // points = makeDataPointsRandom(lows, highs, 10, 0, allow_duplicates);
                    ...
                    case CUSTOM:
                        ...
                        points.add(new Datum(x1));
                        points.add(new Datum(x2));
                        points.add(new Datum(x3));
                        points.add(new Datum(x4));
                        points.add(new Datum(x5));
                        points.add(new Datum(x6));
                        points.add(new Datum(x7));
            ...
            case 2: // Test for 2D points
                ...
                switch(op) {
                    ...
                    case RANDOM:
                        int[] lows = {-500, -500};
                        int[] highs = {500, 500};
                        points = makeDataPointsRandom(lows, highs, 1000, 1, allow_duplicates);
            ...
            case 3: // 3D points
                ...
                switch(op) {
                    ...
                    case RANDOM:
                        int[] lows = {-50, -50, -50};
                        int[] highs = {50, 50, 50};
                        points = makeDataPointsRandom(lows, highs, 100, 2, allow_duplicates);
